				...
				<div className="bg-gradient-to-br from-black/90 via-[#0a0015]/95 to-black/90 rounded-xl border-2 border-[#00f0ff]/50 shadow-2xl shadow-[#00f0ff]/20 p-8">
					<div className="text-center text-white/70">
						<div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-[#00f0ff]/20 to-[#ff00ff]/20 flex items-center justify-center border-2 border-[#00f0ff]/50">
							<Ticket className="w-8 h-8 text-[#00f0ff]" />
						</div>
		...
		<div className="max-w-3xl mx-auto px-4">
			...
			<div className="relative">
				...
				<button
					...
					className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 z-10 w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-r from-[#00f0ff] to-[#0080ff] border-2 border-[#00f0ff] shadow-lg shadow-[#00f0ff]/50 hover:shadow-[#00f0ff]/70 flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 group"
					disabled={data.length <= 1}
				>
					<ChevronLeft className="w-5 h-5 md:w-6 md:h-6 text-black group-hover:text-white transition-colors" />
				</button>
				...
				<button
					...
					disabled={data.length <= 1}
				>
					<ChevronRight className="w-5 h-5 md:w-6 md:h-6 text-black group-hover:text-white transition-colors" />
				</button>

				{/* Ticket Card */}
				<div className="relative bg-gradient-to-br from-black/90 via-[#0a0015]/95 to-black/90 rounded-xl border-2 border-[#00f0ff]/50 shadow-xl shadow-[#00f0ff]/20 overflow-hidden transition-all duration-300">
					{/* Top Neon Line */}
					<div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#00f0ff] via-[#ff00ff] to-[#00f0ff]"></div>
						...
						<div className="flex flex-col gap-4">
							...
							<div className="flex items-start justify-between gap-4">
								<div className="flex-1">
									<h3 className="text-lg md:text-xl font-bold text-[#00f0ff] mb-3 font-vcr">
							...
							<div className="space-y-2 text-white/70 text-sm font-vcr">
								<p className="flex items-center gap-2">
									...
									<span className="text-[#00f0ff]/70 min-w-[60px]">DATE:</span> 
									<span className="text-white/90">{currentTicket.event_date}</span>
								</p>
								<p className="flex items-center gap-2">
									<span className="text-[#ff00ff]">►</span>
									<span className="text-[#00f0ff]/70 min-w-[60px]">TIME:</span> 
									<span className="text-white/90">{currentTicket.event_time}</span>
								</p>
								<p className="flex items-center gap-2">
									<span className="text-[#ff00ff]">►</span>
									<span className="text-[#00f0ff]/70 min-w-[60px]">VENUE:</span> 
					...
					{/* Bottom Neon Line */}
					<div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#00f0ff] via-[#ff00ff] to-[#00f0ff]"></div>
				</div>

				{/* Ticket Counter */}
				<div className="text-center mt-4">
					<p className="text-[#00f0ff] text-sm font-vcr">
						...
						{data.map((_, index) => (
							<button
								...
								className={`w-2 h-2 rounded-full transition-all duration-300 ${
									index === currentIndex
										? "bg-[#00f0ff] w-6 shadow-lg shadow-[#00f0ff]/50"
